...
// Generate an object to disable dates before today
const disablePastDates = {
  dates: (() => {
    ...
    // Generate past dates up to a reasonable limit (e.g., last year)
    for (let i = 0; i < 365; i++) {
...
const handleSelectedTaskStartDate = (date: any) => {
  taskItem.value.startDate = date
}

const handleSelectedTaskEndDate = (date: any) => {
  console.log('Custom dateSelected event triggered with date:', date);
  taskItem.value.endDate = date
}
